...
const Dashboard = () => {
  ...
  return (
    <div className="mx-auto max-w-[50rem] lg:max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mt-[5rem] overflow-x-hidden">
      ...
      {departmentCount > 0 && adminCount > 0 && (
...
// --- Components for icons and cards ---
  ...
  <div className="flex flex-col border shadow-sm rounded-xl bg-slate-900 border-gray-800">
    <div className="p-4 md:p-5">
      ...
      <div className="mt-1 flex items-center gap-x-2">
        <h3 className="text-xl sm:text-2xl font-medium text-gray-200">{value}</h3>
      </div>
    </div>
  </div>
);
...
const ImmutableIcon = () => (
  <svg className="size-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
...
const SecureIcon = () => (
  <svg className="size-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    <path d="M14 9a2 2 0 0 1-2 2H6l-4 4V4" />
  </svg>
);
